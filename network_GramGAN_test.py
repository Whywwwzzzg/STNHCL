...
class Discriminator(nn.Module):
    ...
    def forward(self, input,device):
        ...
        cam_logit_2 = torch.mean(cam_logit_2_0,dim=2,keepdim=False) #第二个维度上求均值，得到形状为 [batch_size, 4]
        ...
        for i in range(4):
            ...
            if i==0:
                out_2 = torch.mean(out_2_0,axis=(2,3),keepdim=False) #out_2_0 的形状是 [batch_size, channels, height, width]  求均值后，out_2 的形状为 [batch_size, channels]，因为移除了空间维度。
